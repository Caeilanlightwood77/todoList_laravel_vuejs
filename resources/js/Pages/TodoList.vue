<template>
    ...
    >
        <div
            class="container mx-auto max-w-4xl bg-white dark:bg-gray-800 shadow-md rounded-lg"
        >
            <!-- Header -->
            <div
                class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gradient-to-r from-blue-500 to-blue-700 text-white"
            >
                <h1 class="text-3xl font-bold">To-Do List</h1>
                <div class="flex items-center gap-4">
                    <button
                        @click="toggleDarkMode"
                        class="px-4 py-2 bg-white text-blue-700 font-semibold rounded-lg shadow-md hover:bg-gray-200"
                    >
            ...
            <div
                class="px-6 py-4 flex flex-col md:flex-row gap-4 justify-between"
            >
                <input
                    v-model="searchQuery"
                    type="text"
                    ...
                    >
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button
                                ...
                                class="px-3 py-1 text-sm rounded-lg shadow-md"
                                :class="
                                    task.status === 'completed'
        ...
        >
            <div
                class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 w-96"
            >
                <h2
